...
get_header(); ?>
		...
		<div id="body_wrapper" class="single-attachment container_24">
			<div id="content" role="main" class="grid_16">

<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>

				<?php if ( ! empty( $post->post_parent ) ) : ?>
					<p class="page-title"><a href="<?php echo get_permalink( $post->post_parent ); ?>" title="<?php esc_attr( printf( __( 'Return to %s', 'jboil' ), get_the_title( $post->post_parent ) ) ); ?>" rel="gallery"><?php
