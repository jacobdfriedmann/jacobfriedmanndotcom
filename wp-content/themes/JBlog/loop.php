...
<?php if ( ! have_posts() ) : ?>
	<article id="post-0" class="post error404 not-found">
		...
		<div class="entry-content">
			<p><?php _e( 'Apologies, but no results were found for the requested archive. Perhaps searching will help find a related post.', 'jboil' ); ?></p>
			<?php get_search_form(); ?>
		</div><!-- .entry-content -->
	</article><!-- #post-0 -->
<?php endif; ?>
...
<?php /* How to display posts in the Gallery category. */ ?>
	...
	<?php if ( in_category( _x('gallery', 'gallery category slug', 'jboil') ) ) : ?>
...
?>
				...
				<p><em><?php printf( __( 'This gallery contains <a %1$s>%2$s photos</a>.', 'jboil' ),
						'href="' . get_permalink() . '" title="' . sprintf( esc_attr__( 'Permalink to %s', 'jboil' ), the_title_attribute( 'echo=0' ) ) . '" rel="bookmark"',
						$total_images
					); ?></em></p>
...
<?php endif; ?>
			...
			<footer class="entry-utility">
				<a href="<?php echo get_term_link( _x('gallery', 'gallery category slug', 'jboil'), 'category' ); ?>" title="<?php esc_attr_e( 'View posts in the Gallery category', 'jboil' ); ?>"><?php _e( 'More Galleries', 'jboil' ); ?></a>
...
<?php /* How to display posts in the asides category */ ?>
	...
	<?php elseif ( in_category( _x('asides', 'asides category slug', 'jboil') ) ) : ?>
		<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
...
<?php if (  $wp_query->max_num_pages > 1 ) : ?>
				<nav id="nav-below" class="navigation">
					<div class="nav-previous"><?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Older posts', 'jboil' ) ); ?></div>
					<div class="nav-next"><?php previous_posts_link( __( 'Newer posts <span class="meta-nav">&rarr;</span>', 'jboil' ) ); ?></div>
				</nav><!-- #nav-below -->
<?php endif; ?>